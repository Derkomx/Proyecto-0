		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active">Publicar en inicio</li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-8 mx-auto text-center">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="titulo" maxlength="128" placeholder="Indicar un título" onKeyUp="count_it()" onKeyDown="count_it()">
...
<script>
	...
	function Publicar() {
		...
		var theJSON = {Archivo: 'Publicaciones.php', Tipo: 'Publicar', Titulo: Titulo, Imagen: Imagen, Cuerpo: Cuerpo, Fecha: Fecha};
		uploadJSON(theJSON);
	}
</script>
