<?php
	...
	$DatosReclamo = obtenerReclamo($Reclamo, $mysqli);
	// Obtiene las respuestas del reclamo
	$Respuestas = obtenerRespuestasReclamo($Reclamo, $ID, $mysqli);
			...
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						...
						<h4><small><?php echo "Departamento: " .obtenerDepartamento($DatosReclamo[2]); ?></small></h4>
						<h4>
							<small>Reclamo #<?php echo $Reclamo; ?></small>
							<?php $Estado = obtenerEstadoReclamo($DatosReclamo[3]); ?>
...
<script src="Scripts/Reclamos.js"></script>