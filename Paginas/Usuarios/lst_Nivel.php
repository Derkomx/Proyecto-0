...
<section class="content">
	<div class="container-fluid">
		<div class="alert alert-info text-center" role="alert">
			...
			Aquí se listan todos los usuarios que poseen un nivel superior al de usuario.
		</div>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Listado de usuarios con niveles</h3>
					</div>
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<?php 
									$Usuarios = obtenerUsuariosNv($mysqli);
									...
									foreach($Usuarios as $ID) {
										...
										<td>'.obtenerDescripcionNivel($Datos[10], $mysqli).'</td>';
										echo '</tr>';
									}
								?>
							</tbody>
