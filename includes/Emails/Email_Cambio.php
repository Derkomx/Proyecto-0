							...
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								...
								<tr>
									...
									<div class="mktEditable" id="main_text">
										...
										Esto es un correo de confirmación para cambiar el correo electrónico de tu cuenta en la página de la Cooperativa Agropecuaria y de Electricidad Monte Caseros.
										<br><br>
										
										Si usted no realizó dicho cambio, por favor, ignore este mensaje.
									</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="text" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 24px;">
										<div class="mktEditable" id="download_button" style="text-align: center;">
											<a href="https://practicacaemc.000webhostapp.com/?cambiarEmail=<?php echo $Activacion; ?>">
												<button style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;">Actualizar correo</button>
											</a>
										</div>
									</td>
								</tr>
							...
							<table>
								<tr>
									<td align="center" style="font-family: Arial, sans-serif; -webkit-text-size-adjust: none; font-size: 16px;">
										<br/><span style="font-size:12x; font-family: Arial, sans-serif; -webkit-text-size-adjust: none; color: #61955B;" >En caso de que el botón no funcione, copie y pegue el siguiente enlace en su navegador:<br><br>https://practicacaemc.000webhostapp.com/?cambiarEmail=<?php echo $Activacion; ?></span>
									</td>
								</tr>
							</table>
						</td>
