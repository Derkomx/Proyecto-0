										...
										<tr>
											<td class="text" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;">
												<div class="mktEditable" id="main_text">
													¡Hola!<br><br>
													Tus datos de usuario fueron verificados correctamente, ahora podrás acceder a todas las funciones del sistema.<br><br>
												</div>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td class="text" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 24px;">
												<div class="mktEditable" id="download_button" style="text-align: center;">
													<a style="color:#ffffff; background-color: #49CB44; border: 20px solid #49CB44; border-left: 20px solid #49CB44; border-right: 20px solid #49CB44; border-top: 10px solid #49CB44; border-bottom: 10px solid #49CB44;border-radius: 3px; text-decoration:none;" href="https://practicacaemc.000webhostapp.com/">Ir a la Pagina Web</a>										
												</div>
											</td>
										</tr>
									</table>
									...
									<table>
										<tr>
											<td align="center" style="font-family: Arial, sans-serif; -webkit-text-size-adjust: none; font-size: 16px;">
												<br/><span style="font-size:12x; font-family: Arial, sans-serif; -webkit-text-size-adjust: none; color: #61955B;" >En caso de que el botón no funcione, copie y pegue el siguiente enlace en su navegador: https://practicacaemc.000webhostapp.com/</span>
											</td>
										</tr>
									</table>
								</td>
